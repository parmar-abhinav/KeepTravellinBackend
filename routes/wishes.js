...
wishesRouter.get('/', authenticate.verifyUser,async (req, res) => {
  ...
  wishesRouter.get('/:id',authenticate.verifyUser,  async (req, res) => {
...
wishesRouter.post('/',authenticate.verifyUser,(req, res, next) => {
    Wishes.insertMany({
        _id: req.body._id,
