...
servicesRouter.get('/', authenticate.verifyUser,async (req, res) => {
  ...
  servicesRouter.get('/:id', authenticate.verifyUser,async (req, res) => {
...
servicesRouter.post('/', authenticate.verifyUser,(req, res, next) => {
